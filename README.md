...
VALUES 
	('Beverages','Soft Drinks,Coffes,teas,beers, and ales'),
	('Condiments', 'Sweet and savory sauces, relishes, spreads, and seasonings'),
	('Confrections','Desserts, candies, and sweet beads' ),
	('Dairy Products', 'Chesses'),
...
SELECT * FROM customers
WHERE country ('Norway','Sweden','Denmark');
...
// retornar todas las columnas

SELECT * FROM customers;

/*el  SELECT DISCTINCT statement, saca un valor unico de lo que se pide*/
...
El Where clause es usado para filtrar guardados
es usado para extrare solo el lo grabado que se especifica bajo una condicion
*/
...
/* Ordenar por precio normal sera ascendente de 1 hacia ..  y con DESC sera al reves*/)
SELECT * FROM products
ORDER BY price;
...
/* Limite 20 pero que empieza en el 40*/
SELECT * FROM customers
LIMIT 20 OFFSET 40;
